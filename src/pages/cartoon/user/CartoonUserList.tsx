...
import { CartoonUserInfo, opIdToVal, stateOp, terminalOp } from '@/type';
import SearchForm, { SearchFormItem, SelectOpType } from '@/components/searchForm';
import BaseTable from '@/components/base/BaseTable';
import { getCartoonAllSiteApi, getCartoonUserListApi, getCartoonUserStateApi } from '@/request';
import { momentToTime } from '@/utils';

export const CartoonUserList = () => {
    ...
    const [dataSource, setDataSource] = useState<CartoonUserInfo[]>([]);
    ...
    const onStateChange = (id: number) => {
        getCartoonUserStateApi(id).then((res: any) => {
    ...
    const getDataList = () => {
        setLoading(true);
        getCartoonUserListApi({ page: currentPage, per_page: pageSize, ...queryParam }).then((res: any) => {
