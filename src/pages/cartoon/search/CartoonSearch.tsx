...
import { getCartoonSearchListApi, getCartoonAllSiteApi, delCartoonSearchApi } from '@/request'
...
export const CartoonSearchList: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delCartoonSearchApi(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const initData = () => {
        ...
        getCartoonSearchListApi(params).then((res: any) => {
            if (res.code == 200) {
