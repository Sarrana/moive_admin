import { postCartoonSiteAddApi, postCartoonSiteEditApi } from "@/request";
...
export const CartoonSiteListModal = (props: modalPropType) => {
    ...
    const onConfirm = () => {
        form.validateFields().then((v) => {
            ...
            if (isEdit) {
                postCartoonSiteEditApi(params.id, data).then((res: any) => {
                    message.success('修改成功');
                    props.onOk();
                });
            } else {
                postCartoonSiteAddApi(data).then((res: any) => {
