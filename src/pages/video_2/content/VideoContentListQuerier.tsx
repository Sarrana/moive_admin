        ...
        <Space>
            <Form layout="inline">
                ...
                <Form.Item>
                    <Select
                        style={{ width: 100 }}
                        value={props.params.free}
                        onChange={(v, o) => props.onValueChange('select', 'free', v, o)}
                        placeholder="付费模式"
                        allowClear>
                        {
                            costArr.map((status) => (
                ...
                <Form.Item>
                    <Select
                        style={{ width: 80 }}
                        value={props.params.area}
                        onChange={(v, o) => props.onValueChange('select', 'area', v, o)}
                        placeholder="地区"
                        allowClear>
                        {
                            areaArr.map((status) => (
                ...
                <Form.Item>
                    <Select
                        ...
                        onChange={(v, o) => props.onValueChange('select', 'year', v, o)}
                        placeholder="年份"
                        allowClear>
                        {
                            yearArr.map((status) => (
