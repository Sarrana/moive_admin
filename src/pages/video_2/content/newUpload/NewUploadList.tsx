...
export const NewUploadList = () => {
    ...
    const getDataList = () => {
        setLoading(true);
        // 新增 type=1 参数，获取所有
        getVideoExamineListApi_2({ page: currentPage, per_page: pageSize, type: 1, ...queryParam }).then((res: any) => {
    ...
    return (
        <>
            ...
            {modalData && <NewUploadModal params={modalData} onHide={onHideModal} />}
        </>
    )
}
