...
import { getVideoSortVideoListApi_2, postVideoSortVideoAddApi_2 } from '@/request'
...
export const ContentSortSettingAddModal: React.FC<AddModalPropType> = (P) => {
    ...
    const onFinish = () => {
        if (selectedRowKeys && selectedRowKeys.length) {
            postVideoSortVideoAddApi_2(recommend_id, { ids: selectedRowKeys.join(',') }).then((res: any) => {
    ...
    const initData = () => {
        ...
        getVideoSortVideoListApi_2(recommend_id, { page, per_page, ...forQueryParam }).then((res: any) => {
