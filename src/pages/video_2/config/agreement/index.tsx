...
import {
    getUserAgreementsListApi_2, getVideoAllSiteApi_2, addUserAgreementsApi_2, getUserAgreementsDetailApi_2, updateUserAgreementsApi_2,
    updateUserAgreementsStatuslApi_2, delUserAgreementslApi_2
} from '@/request'
...
export const AgreementMgr: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delUserAgreementslApi_2(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const handleItem = (id: number) => {
        ...
        getUserAgreementsDetailApi_2(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: ParamsDataType) => {
        const operationApi = params.id ? updateUserAgreementsApi_2 : addUserAgreementsApi_2
    ...
    const initData = () => {
        setLoadingTable(true)
        getUserAgreementsListApi_2({ page, per_page }).then((res: any) => {
            if (res.code == 200) {
