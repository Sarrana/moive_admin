...
import {
    getWebKeywordsListApi_2, addWebKeywordsApi_2, getVideoAllSiteApi_2, getWebKeywordsDetailApi_2, updateWebKeywordsApi_2,
    delWebKeywordsApi_2, updateWebKeywordsStatusApi_2
} from '@/request'
...
export const KeywordMgr: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delWebKeywordsApi_2(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const changeStatus = (id: number) => {
        updateWebKeywordsStatusApi_2(id).then((res: any) => {
            if (res.code == 200) {
                message.success(res.message)
                initData()
            } else {
    ...
    const handleItem = (id: number) => {
        getWebKeywordsDetailApi_2(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: ParamsDataType) => {
        const operationApi = params.id ? updateWebKeywordsApi_2 : addWebKeywordsApi_2
    ...
    const initData = () => {
        ...
        getWebKeywordsListApi_2({ page, per_page, web_name: '' }).then((res: any) => {
            if (res.code == 200) {
