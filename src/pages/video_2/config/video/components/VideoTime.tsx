...
import { getVideoYearsListApi_2, addVideoYearsApi_2, updateVideoYearsApi_2, delVideoYearsApi_2 } from '@/request'
...
export const VideoTime: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delVideoYearsApi_2(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: BaseDataType) => {
        const operationApi = params.id ? updateVideoYearsApi_2 : addVideoYearsApi_2
    ...
    const initData = () => {
        ...
        getVideoYearsListApi_2({ page, per_page }).then((res: any) => {
            if (res.code == 200) {
