...
import { getVideoAllSiteApi, getVideoUserListApi, getVideoUserStateApi } from '@/request';
...
export const VideoUserList = () => {
    ...
    const onDetail = (id: number) => {
        navigate(`/Video/UserMgr/UserList/Detail?id=${id}`, { replace: false });
    }
    const onStateChange = (id: number, status: boolean) => {
        getVideoUserStateApi({ id: id }).then((res: any) => {
    ...
    const getDataList = (data) => {
        ...
        setLoading(true);
        getVideoUserListApi(data).then((res: any) => {
