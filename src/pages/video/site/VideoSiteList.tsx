...
import { delVideoSiteApi, getVideoSiteListApi, getVideoSiteStateApi } from '@/request';
...
export const VideoSiteList = () => {
    ...
    const getDataList = (data) => {
        ...
        setLoading(true);
        getVideoSiteListApi(data).then((res: any) => {
