...
import { getVideoCategoriesListApi, addVideoCategoriesApi, updateVideoCategoriesApi, delVideoCategoriesApi } from '@/request'
...
export const VideoClassify: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delVideoCategoriesApi(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: BaseDataType) => {
        const operationApi = params.id ? updateVideoCategoriesApi : addVideoCategoriesApi
    ...
    const initData = () => {
        ...
        getVideoCategoriesListApi({ page, per_page }).then((res: any) => {
            if (res.code == 200) {
