...
import { getVideoTypesListApi, addVideoTypesApi, updateVideoTypesApi, delVideoTypesApi, getVideoAllCategoryApi } from '@/request'
...
export const VideoType: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delVideoTypesApi(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: BaseDataType) => {
        const operationApi = params.id ? updateVideoTypesApi : addVideoTypesApi
    ...
    const initData = () => {
        ...
        getVideoTypesListApi({ page, per_page }).then((res: any) => {
            if (res.code == 200) {
