...
import { getVideoAreasListApi, addVideoAreasApi, updateVideoAreasApi, delVideoAreasApi } from '@/request'
...
export const VideoRegion: React.FC = () => {
    ...
    const handleDel = (id: number) => {
        delVideoAreasApi(id).then((res: any) => {
            if (res.code == 200) {
    ...
    const modalConfirm = (params: BaseDataType) => {
        const operationApi = params.id ? updateVideoAreasApi : addVideoAreasApi
    ...
    const initData = () => {
        ...
        getVideoAreasListApi({ page, per_page }).then((res: any) => {
            if (res.code == 200) {
