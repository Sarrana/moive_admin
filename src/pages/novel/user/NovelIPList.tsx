...
import { NovelUserIp, terminalOp } from '@/type';
import SearchForm, { SearchFormItem, SelectOpType } from '@/components/searchForm';
import BaseTable from '@/components/base/BaseTable';
import { getNovelAllSiteApi, getNovelUserIpListApi } from '@/request';

export const NovelIPList = () => {
    ...
    const [dataSource, setDataSource] = useState<NovelUserIp[]>([]);
    ...
    const getDataList = () => {
        setLoading(true);
        getNovelUserIpListApi({ page: currentPage, per_page: pageSize, ...queryParam }).then((res: any) => {
